...
public class AnotherOrdersBusinessService implements OrdersBusinessServiceInterface {
	...
	public void init() {
		// TODO Auto-generated method stub
		System.out.println("Calling init() method from AnotherOrderBusinessService class");
	}

	@Override
	public void destroy() {
		// TODO Auto-generated method stub
		System.out.println("Calling destroy() method from AnotherOrderBusinessService class");
	}
